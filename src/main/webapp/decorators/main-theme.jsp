		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container-fluid">
					<a class="brand" href="${ctx}/accounts/${currentAccount.id}/ec2/overview">Clouck</a>
					<div class="nav-collapse collapse">
						<ul class="nav">
							<li class="<c:if test="${currentServiceMenu == 'ec2'}">active</c:if>"><a href="${ctx}/accounts/${currentAccount.id}/ec2/overview">EC2</a></li>
	                        ...
	                        <li id="fat-menu" class="dropdown">
	                            ...
	                            <ul class="dropdown-menu" role="menu" aria-labelledby="drop3">
	                                <c:forEach var="account" items="${accounts}">
	                                    <li role="presentation">
	                                        <a role="menuitem" tabindex="-1" href="${ctx}/accounts/${account.id}/ec2/overview">${account.name}</a>
	                                    </li>
	                                </c:forEach>
	                                <li>
		                            <c:choose>
					...
					<div class="well sidebar-nav">
						<ul class="nav nav-list" style="padding-left: 35px;padding-right: 15px;">
							<li class="<c:if test="${currentResourceMenu == 'overview'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/overview">Overview</a>
							</li>
							...
							<li class="<c:if test="${currentResourceMenu == 'amis'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/amis/versions">AMIs</a>
							</li>
							<li class="nav-header">ELASTIC BLOCK STORE</li>
							<li class="<c:if test="${currentResourceMenu == 'volumes'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/volumes/versions">Volumes</a>
							</li>
							<li class="<c:if test="${currentResourceMenu == 'snapshots'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/snapshots/versions">Snapshots</a>
							</li>
							<li class="nav-header">NETWORK & SECURITY</li>
							<li class="<c:if test="${currentResourceMenu == 'securityGroups'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/securityGroups/versions">Security Groups</a>
							</li>
							<li class="<c:if test="${currentResourceMenu == 'elasticIPs'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/elasticIPs/versions">Elastic IPs</a>
							</li>
							<li class="<c:if test="${currentResourceMenu == 'placementGroups'}">active</c:if>">
							    <a href="${ctx}/accounts/${currentAccount.id}/ec2/placementGroups/versions">Placement Groups</a>
							</li>
