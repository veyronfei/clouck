...
<div class="row-fluid">
    <div class="span13">
        <ul class="breadcrumb">
            <li><a href="${ctx}/accounts/${currentAccount.id}/ec2/loadBalancers/versions">Load Balancers</a> <span class="divider">&gt;</span></li>
            <li class="active">
                <i class="icon-time"></i>
            ...
            <tbody>
                <c:forEach items="${ec2Resources}" var="ec2Resource">
                 <tr>
                    ...
                    <td>
                        <a href="${ctx}/accounts/${currentAccount.id}/ec2/loadBalancers/${ec2Resource.id}?at=${at.time}">${ec2Resource.resource.loadBalancerName}</a>
                    </td>
