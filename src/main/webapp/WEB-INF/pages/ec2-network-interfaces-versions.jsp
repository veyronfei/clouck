...
<div class="row-fluid">
    ...
    <div class="span3">
        <div class="id-filter">Network Interface ID:</div>
...
<div class="row-fluid">
    <table id="networkInterfaceVersionsTable" class="table table-striped table-hover">
        <thead>
            <tr>
...
$(document).ready(function() {
    ...
    oTable = $('#networkInterfaceVersionsTable').dataTable({
        "bServerSide": true,
        "bProcessing": true,
        "bLengthChange": false,
        "bFilter": false,
