...
<div class="row-fluid">
    <div class="span13">
        <ul class="breadcrumb">
            <li><a href="${ctx}/accounts/${currentAccount.id}/ec2/elasticIPs/versions">Elastic IPs</a> <span class="divider">&gt;</span></li>
            <li class="active">
                <i class="icon-time"></i>
            ...
            <tbody>
                ...
                <c:set var="resource" value="${ec2Resource.resource}"/>
                 <tr>
                    ...
                    <td>
                        <a href="${ctx}/accounts/${currentAccount.id}/ec2/elasticIPs/${ec2Resource.id}?at=${at.time}">${resource.publicIp}</a>
                    </td>
