...
<div class="row-fluid">
    <div class="span13">
        <ul class="breadcrumb">
            <li><a href="/app/accounts/${currentAccount.id}/ec2/placementGroups/versions">Placement Groups</a> <span class="divider">&gt;</span></li>
            <li class="active">
                <i class="icon-time"></i>
            ...
            <tbody>
                ...
                <c:set var="resource" value="${ec2Resource.resource}"/>
                 <tr>
                    ...
                    <td>
                        <a href="/app/accounts/${currentAccount.id}/ec2/placementGroups/${ec2Resource.id}?at=${at.time}">${resource.groupName}</a>
                    </td>
