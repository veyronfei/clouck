...
<div class="row-fluid">
    <div class="span13">
        ...
        <div class="span1 offset5">
            <a class="btn" href="/app/accounts/${currentAccount.id}/ec2/versions/networkInterfaces${regionUrl}">${numOfEc2VersionMetas} versions</a>
        </div>
            ...
            <tbody>
                ...
                <c:set var="resource" value="${ec2Resource.resource}"/>
                 <tr>
                    ...
                    <td>
                        <a href="/app/accounts/${currentAccount.id}/ec2/networkInterfaces/${ec2Resource.id}${regionUrl}">${resource.networkInterfaceId}</a>
                    </td>
