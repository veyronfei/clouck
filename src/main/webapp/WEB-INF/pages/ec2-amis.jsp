...
<div class="row-fluid">
    <div class="span13">
        <ul class="breadcrumb">
            <li><a href="/app/accounts/${currentAccount.id}/ec2/amis/versions">AMIs</a> <span class="divider">&gt;</span></li>
            <li class="active">
                <i class="icon-time"></i>
            ...
            <tbody>
                ...
                <c:set var="resource" value="${ec2Resource.resource}"/>
                 <tr>
                    ...
                    <td>${resource.name}</td>
                    <td>
                        <a href="/app/accounts/${currentAccount.id}/ec2/amis/${ec2Resource.id}?at=${at.time}">${resource.imageId}</a>
                    </td>
