...
<div class="row-fluid">
    ...
    <div class="span3">
        <div class="id-filter">AMI ID:</div>
    ...
    <div class="span2" style="display: inline;">
        <button id ="filter" class="btn btn-primary" type="button" onclick="javascript:filterVersions('${currentAccount.id}', 'amis', '${ctx}')">Filter</button>
        <button class="btn btn-primary" type="button" onclick="javascript:clearFilter('${currentAccount.id}', 'amis', '${ctx}')">Clear</button>
    </div>
</div>

<div class="row-fluid">
    <table id="amiVersionsTable" class="table table-striped table-hover">
            <thead>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        oTable = $('#amiVersionsTable').dataTable({
            "bServerSide": true,
            "bProcessing": true,
            "bLengthChange": false,
            "bFilter": false,
            "bSort": false,
            "sAjaxSource": "${ctx}/rest/dataTable/accounts/${currentAccount.id}/ec2/versions/amis"
        });
    });
</script>
</body>
