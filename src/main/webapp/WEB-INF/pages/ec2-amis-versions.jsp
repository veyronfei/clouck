...
<div class="row-fluid">
    ...
    <div class="span2" style="display: inline;">
        <button id ="filter" class="btn btn-primary" type="button" onclick="javascript:filterVersions('${currentAccount.id}', 'amis')">Filter</button>
        <button class="btn btn-primary" type="button" onclick="javascript:clearFilter('${currentAccount.id}', 'amis')">Clear</button>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        oTable = $('#amiVersionsTable').dataTable({
            ...
            "bFilter": false,
            "bSort": false,
            "sAjaxSource": "/app/rest/dataTable/accounts/${currentAccount.id}/ec2/versions/amis"
        });
    });
</script>
</body>
