...
<title>Placement Groups History</title>
<style type="text/css">
...
<div class="row-fluid">
    ...
    <div class="span3">
        <div class="id-filter">Placement Group Name:</div>
...
<div class="row-fluid">
    <table id="placementGroupVersionsTable" class="table table-striped table-hover">
            <thead>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        oTable = $('#placementGroupVersionsTable').dataTable({
            "bServerSide": true,
            "bProcessing": true,
            "bLengthChange": false,
            "bFilter": false,
            "bSort": false,
            "sAjaxSource": "/app/rest/dataTable/accounts/${currentAccount.id}/ec2/versions/placementGroups"
        });
    });
</script>
</body>
