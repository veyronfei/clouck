...
<div class="row-fluid">
    ...
    <div class="span2" style="display: inline;">
        <button id ="filter" class="btn btn-primary" type="button" onclick="javascript:filterVersions('${currentAccount.id}', 'snapshots')">Filter</button>
        <button class="btn btn-primary" type="button" onclick="javascript:clearFilter('${currentAccount.id}', 'snapshots')">Clear</button>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        oTable = $('#snapshotVersionsTable').dataTable({
            ...
            "bFilter": false,
            "bSort": false,
            "sAjaxSource": "/app/rest/dataTable/accounts/${currentAccount.id}/ec2/versions/snapshots"
        });
    });
</script>
</body>
