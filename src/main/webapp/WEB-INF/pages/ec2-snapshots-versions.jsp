...
<div class="row-fluid">
    ...
    <div class="span3">
        <div class="id-filter">Snapshot ID:</div>
    ...
    <div class="span2" style="display: inline;">
        <button id ="filter" class="btn btn-primary" type="button" onclick="javascript:filterVersions('${currentAccount.id}', 'snapshots', '${ctx}')">Filter</button>
        <button class="btn btn-primary" type="button" onclick="javascript:clearFilter('${currentAccount.id}', 'snapshots', '${ctx}')">Clear</button>
    </div>
</div>

<div class="row-fluid">
    <table id="snapshotVersionsTable" class="table table-striped table-hover">
            <thead>
                <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        oTable = $('#snapshotVersionsTable').dataTable({
            "bServerSide": true,
            "bProcessing": true,
            "bLengthChange": false,
            "bFilter": false,
            "bSort": false,
            "sAjaxSource": "${ctx}/rest/dataTable/accounts/${currentAccount.id}/ec2/versions/snapshots"
        });
    });
</script>
</body>
